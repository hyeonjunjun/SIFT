...
async function testFailingSift() {
    const data = JSON.stringify({
        url: "https://www.tiktok.com/t/ZP8uPkLmT/",
    ...
    console.log('Sending SIFT request to production for FAILING URL: https://www.tiktok.com/t/ZP8uPkLmT/...');
